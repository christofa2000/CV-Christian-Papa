...
const knowledgeBase = [
  {
    id: "stack",
    text: "Mi stack tecnológico principal incluye: React, Next.js, React Native, TypeScript, Vite, Zustand, Redux Toolkit, React Query, TailwindCSS, Material UI, ShadCN, Ant Design, Jest, Vitest, React Testing Library, Node.js, Prisma, Postgres, Supabase, Git y Vercel.",
  },
  {
    id: "experiencia",
    text: "Trabajo como React Developer en Santander Tecnología Argentina desde junio 2024. Anteriormente trabajé en Despegar, Bewise, Círculo Mágico y como freelancer.",
  },
  {
    id: "contacto",
